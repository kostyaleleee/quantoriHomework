...
describe ('Pre-conditions', () => {
    ...
    it('Happy path scenario', async () => {
        ...
        await $('//*[@id="ctl00_MainContent_fmwOrder_ddlProduct"]').click(); // clicking on the Product dropdown to get a list of options
        await $('//*[@id="ctl00_MainContent_fmwOrder_ddlProduct"]/option[2]').click(); // selecting FamilyAlbum
        await $('//*[@id="ctl00_MainContent_fmwOrder_txtQuantity"]').setValue("10"); // Quantity
        await $('//*[@id="ctl00_MainContent_fmwOrder_txtUnitPrice"]').setValue("80"); // Price for unit
        await $('//*[@id="ctl00_MainContent_fmwOrder_txtDiscount"]').setValue("15"); // Discount
